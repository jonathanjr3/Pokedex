...
export const AboutScene: React.FC<{
	...
	const genderDisplay = useMemo(() => {
		if (genderRate === -1)
			return <Text style={{ color: theme.text }}>Genderless</Text>;
		...
		return (
			<View style={styles.genderRow}>
				...
				<Text style={[{ color: theme.text, marginLeft: 5, marginRight: 15 }]}>
					{maleChance.toFixed(1)}%
				</Text>
	...
	return (
		...
		>
			...
			<View style={[styles.row]}>
				<View
					style={[cardStyle, shadowStyle, styles.infoCard, styles.rowItemFirst]}
				>
					<MaterialCommunityIcons
						name="ruler"
						size={20}
				...
				<View
					style={[cardStyle, shadowStyle, styles.infoCard, styles.rowItemLast]}
				>
					<MaterialCommunityIcons
